...
import com.management.dto.validators.CreatePatientValidationGroup;
...
public class PatientController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<PatientResponseDTO> updatePatient(@PathVariable UUID id, @RequestBody 
